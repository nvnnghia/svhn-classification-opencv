...
tf.app.flags.DEFINE_string('restore_checkpoint', None,
                           'Path to restore checkpoint (without postfix), e.g. ./logs/train/model.ckpt-62000')
FLAGS = tf.app.flags.FLAGS


def main(_):
    path_to_image_file = 'images/10.png'
    path_to_restore_checkpoint_file = 'log/latest.ckpt'
